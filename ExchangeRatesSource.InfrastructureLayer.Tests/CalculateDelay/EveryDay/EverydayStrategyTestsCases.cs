...
[Category("test_cases")]
internal class EverydayStrategyTestsCases : EverydayStrategyTestsBase
{
    protected static IEnumerable<TestCaseData> DateTimesToExpectedDay => new[]
    {
        ...
        new TestCaseData(new DateTime(2021, 12, 31), new DateOnly(2022, 1, 1)),
