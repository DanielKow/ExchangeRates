...
public class GetExchangeRatesChainBuilder : IGetExchangeRatesChainBuilder
{
    ...
    {
        var internalSourceChainLink = new GetFromInternalSourceChainLink(_httpClient, _internalSourcesConfig, _logger);
        var externalSourceChainLink =
            new GetFromExternalSourceChainLink(_exchangeRatesSource, _externalSourcesConfig, _logger);
